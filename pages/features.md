  ...
  <div class="container-sm px-2">
    <div class="row justify-content-center">
      <div class="col-12 col-md-6 col-lg-6 pb-3">
        <h1 class="rainbow">Es la hora de cuidar de tu salud mental</h1>
      ...
      <div class="col-12 col-md-6 col-lg-6 pb-4">
        <img alt="Iridis app" class="img-fluid" width="100%" src="/assets/images/landings/features/app.webp" />
      </div>
    </div>
  </div>
</div>
...
<div class="strip-white">
  <div class="container-sm pb-4 px-2">
    <div class="feature-product-title">
      ...
      <h4 style="font-size: 1.2em;">Vuelve a tu interior con sonidos personalizados.</h4>
      <p style="color: #262626; font-size: 1.15rem;">Conócete mejor, controla tus emociones y mantén a raya el estrés. Ideal para personas con estrés, ansiedad, depresión, carga emocional o están trabajando su interior. </p>
    </div>
  </div>
</div>
